...
//import '../../../perfil/presentation/pages/editar_perfil_page.dart';

class TecnicoPerfilPage extends StatelessWidget {
  const TecnicoPerfilPage({super.key});
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          const Text(
            'Aquí se mostrará especialidad, experiencia, disponibilidad, etc.',
